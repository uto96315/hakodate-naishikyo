...
const AboutEndoscopy: React.FC<Props> = () => {
    ...
    const menus = [
        ...
        { title: "内視鏡検査（胃カメラ）の流れ", id: "gastroscope" },
        { title: "内視鏡検査(大腸内視鏡)の流れ", id: "colonoscop" },
    ...
    const nasalEndoscopeMerit = [
        "約5mmの細い内視鏡を鼻から入れるため、舌を圧迫しないため、嘔気を感じずに楽に検査を受けられます",
            ...
            <div id="sedative" className="my-10 px-10">
                ...
                <div>
                    <p>
                        ...
                        院長も経口内視鏡は苦しく苦手でした。鎮静剤を用いた内視鏡検査は、不安なく安心して受けて頂け、
                        検査する側からも、落ち着いて検査が可能なため、とても有用な検査です。<br />
                    ...
                    <p>
                        当院では問診と内視鏡所見からリスクに応じた内視鏡観察と、リスクに応じた対応を当日説明して
                        いますが、鎮静剤をもちいると、十分な検査や結果説明が出来ないことが一番のデメリットです。<br />
                        そのため、当院では経鼻内視鏡、細い大腸内視鏡など苦痛の少ない内視鏡検査を鎮静せずに
                        行うことをお勧めしています。<br />
