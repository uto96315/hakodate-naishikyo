...
const AboutOnlineTreatment = () => {
    ...
    const handleExternalLinkClick = (url:string) => {
        window.open(url, '_blank'); // 新しいタブまたはウィンドウで外部リンクを開く
    };
    return (
        <div className="pb-10">
            ...
            <div className="px-5 md:px-20">
                ...
                <ul className="md:px-20 flex justify-center">
                    <div className="md:px-28 md:w-3/4">
                        <div className="py-2">
                ...
                <div className="flex justify-center">
                    <div className="space-y-1 md:px-28 md:w-3/4">
                        <p>①
                        ...
                        <p>③事前にクリニックの
                            <a href="https://lin.ee/Ugle9mq" className=" border-b border-blue-500 text-blue-500">公式LINE</a>
                            にお友達登録をします。</p>
                ...
                <div className="md:flex md:px-20 pt-5 pb-20 space-y-3 md:space-y-0 justify-center">
                    <div onClick={() => { handleExternalLinkClick("https://ssc.doctorqube.com/hakodate-naishikyou/")}} className="px-5 py-5 shadow text-center border-2 rounded-xl bg-gray-700">
                        <p className="font-bold text-white">オンライン予約</p>
                    </div>

                    <div onClick={() => { handleExternalLinkClick("https://lin.ee/Ugle9mq")}} id="carada" className="px-5 py-5 shadow text-center border-2 rounded-xl bg-green-500">
                        <p className="font-bold text-white">公式LINE</p>
                    </div>

                    <div onClick={() => { handleExternalLinkClick("https://apps.apple.com/jp/app/carada-lian-xieapuri/id1106740618")}} id="carada" className="px-5 py-5 shadow text-center border-2 rounded-xl bg-yellow-400">
                        <p className="font-bold text-white">CARADA（iPhone）</p>
                    </div>

                    <div onClick={() => { handleExternalLinkClick("https://play.google.com/store/apps/details?id=jp.co.mti.carada.app&hl=ja")}} className="px-5 py-5 shadow text-center border-2 rounded-xl bg-yellow-400">
                        <p className="font-bold text-white">CARADA（Android）</p>
                    </div>
                </div>
            </div>
        </div>
