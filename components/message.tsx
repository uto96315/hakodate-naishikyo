...
const Message: React.FC = () => {
    return (
        <div className="min-w-screen px-10 py-10">
            ...
            <div className="py-5 shadow-2xl -mx-4 -my-2">
                <div className="flex space-x-3">
                    ...
                    <div className="w-full h-min py-10 px-10">
                        <h2 className="text-3xl font-sans font-semibold pb-5 text-center">
                            健康をサポートし”笑顔”に！
                        </h2>
                        <p className="pt-2 space-x-1 text-lg leading-9 px-14">
                        ...
                        <div className="flex justify-center items-center py-14 text-white">
                            <button className="py-3 px-20 rounded-lg shadow-md bg-theme flex">
                                詳しく見る
