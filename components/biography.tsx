...
const biographyData = [
    ...
    {
        when: "2008年",
        text: ["KKR札幌医療センター消化器科医長"]
    },
    {
        when: "2010年",
        text: ["北海道大学病院 第3内科 助教"]
    },
    {
        when: "2014年",
        text: ["北海道大学大学院医学研究科がん予防内科 特任講師"]
    },
    {
        when: "2016年",
        text: ["国立病院機構 函館病院 消化器科部長・消化器病センター長", "北海道大学病院光学医療診療部 客員臨床教授"]
    },
    {
        when: "2019年",
        text: ["淳風会健康管理センター 倉敷センター長"]
    },
    {
        when: "2023年",
        text: ["まべ五稜郭消化器・内視鏡クリニック 院長"]
    },
];
